...
export const AUTOMATIONS: AutomationDefinition[] = [
  ...
  },
  {
    ...
    displayStats: [
      ...
      { key: 'workers_completed', label: 'workers' },
      { key: 'queue_remaining', label: 'queue' },
    ],
    primaryStatKey: 'new',
  },
  {
    id: 'werkenindekempen-finalize',
    displayName: 'Werkenindekempen finalize',
    description: 'Aggregate orchestration-results en archiveer delisted vacatures',
    category: 'maintenance',
    schedule: '*/5 * * * *',
    expectedIntervalMs: 5 * MINUTE,
    handlerPath: '/api/cron/werkenindekempen-finalize',
    displayStats: [
      { key: 'orchestrations_finalized', label: 'orch klaar' },
      { key: 'orchestrations_pending', label: 'orch open' },
      { key: 'stale_processing_reaped', label: 'crashed workers reset' },
      { key: 'new', label: 'nieuw' },
      { key: 'updated', label: 'updates' },
      { key: 'errors', label: 'errors' },
    ...
    primaryStatKey: 'orchestrations_finalized',
  },
  {
